...
<body>
    ...
    <br>
                        ...
                        //create a database insertion for payments logging
                            ...
                            $country = 'UG';
                            $tunnel = 'isys';
                            $merchant_name = 'provided by one global';
                           $akey = 'provided by one global';
                           $original = urlencode ('provided by one global');              
                           $decryptedOriginal = 'provided by one global';
                            $timestamp = time();
                            $rnd = "";
    ...
    $merchantResponseUrl = 'donate.php';
          ...
          <input type="hidden" name ="isysid" value="<?php echo getTransactionID(18); ?>" />
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <select id="ctry" name='country'class="form-control" required>
              ...
              <div class="form-group col-md-4">
                ...
                <select id="don" name="donation" class="form-control" required>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="amount" id="amt" placeholder="Enter Amount"required>
              </div>
            </div>
            <div class="form-row">
